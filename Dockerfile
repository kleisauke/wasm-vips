...
FROM docker.io/emscripten/emsdk:4.0.19
...
# Emscripten patches
RUN \
  curl -Ls https://github.com/emscripten-core/emscripten/compare/4.0.19...kleisauke:wasm-vips-4.0.19.patch | patch -p1 -d $EMSDK/upstream/emscripten && \
...
RUN \
  curl https://sh.rustup.rs -sSf | sh -s -- -y \
    ...
    --default-toolchain nightly-2025-11-07 \
    --component rust-src
