...
FROM docker.io/emscripten/emsdk:4.0.20
...
# Emscripten patches
RUN \
  curl -Ls https://github.com/emscripten-core/emscripten/compare/4.0.20...kleisauke:wasm-vips-4.0.20.patch | patch -p1 -d $EMSDK/upstream/emscripten && \
