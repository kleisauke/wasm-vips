...
FROM docker.io/emscripten/emsdk:4.0.21
...
# Emscripten patches
RUN \
  curl -Ls https://github.com/emscripten-core/emscripten/compare/4.0.21...kleisauke:wasm-vips-4.0.21.patch | patch -p1 -d $EMSDK/upstream/emscripten && \
