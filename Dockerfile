...
FROM docker.io/emscripten/emsdk:3.1.41
...
# Emscripten patches
RUN \
  curl -Ls https://github.com/emscripten-core/emscripten/compare/3.1.41...kleisauke:wasm-vips-3.1.41.patch | patch -p1 -d $EMSDK/upstream/emscripten && \
