...
FROM docker.io/emscripten/emsdk:3.1.45
...
# Emscripten patches
RUN \
  curl -Ls https://github.com/emscripten-core/emscripten/compare/3.1.45...kleisauke:wasm-vips-3.1.45.patch | patch -p1 -d $EMSDK/upstream/emscripten && \
...
RUN \
  curl https://sh.rustup.rs -sSf | sh -s -- -y \
    ...
    --default-toolchain nightly-2023-09-01 \
    --component rust-src
