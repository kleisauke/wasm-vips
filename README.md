...
and currently available only behind feature flags, in beta builds, or in the
latest Firefox versions.

For V8-based engines, at least version 14.4 is required, this corresponds to
Chrome 144 (in beta from Dec 3 to 18). The feature was previously available
behind the `--experimental-wasm-rab-integration` flag in V8 13.6, as shipped
in [Node.js 24](https://github.com/nodejs/node/pull/58070) and [Deno 2.3.2](
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| :hourglass_flowing_sand:<br>[version 144+](https://github.com/v8/v8/commit/544e1c01b080671b3cb2212ed4d112c3dcf89eb5) | :heavy_check_mark:<br>[version 145+](https://github.com/mozilla-firefox/firefox/commit/eeffcce0310b31a398d56467e21686c2b14562cc) | :hourglass_flowing_sand:<br>[version 26.2+](https://github.com/WebKit/WebKit/commit/b3fa045c1cb905093b83e16917f209a9ef0768a4) | :hourglass_flowing_sand:<br>[version 144+](https://github.com/v8/v8/commit/544e1c01b080671b3cb2212ed4d112c3dcf89eb5) | :x:<br>[Tracking bug](https://issues.chromium.org/issues/42202693) | :x:<br>[Tracking bug](https://issues.chromium.org/issues/42202693) |
