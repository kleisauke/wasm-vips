...
An engine that supports [resizable buffers](
https://webstatus.dev/features/resizable-buffers). This is present on most
major browser engines and is part of [Baseline 2024](
https://web.dev/baseline/2024).

For V8-based engines, at least version 11.2 is required, this corresponds to
Chrome 111, Node.js 20.0.0 and Deno 1.33.0.

For Spidermonkey-based engines, the JavaScript engine used in Mozilla Firefox
and whose version numbers are aligned, at least version 128 is required.
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| :heavy_check_mark:<br>[version 111+](https://chromestatus.com/feature/4668361878274048) | :heavy_check_mark:<br>[version 128+](https://bugzil.la/1884150) | :heavy_check_mark:<br>[version 16.4+](https://webkit.org/blog/13966/webkit-features-in-safari-16-4/#javascript-and-webassembly) | :heavy_check_mark:<br>[version 111+](https://chromestatus.com/feature/4668361878274048) | :heavy_check_mark:<br>[version 20+](https://github.com/nodejs/node/pull/47251) | :heavy_check_mark:<br>[version 1.33+](https://github.com/denoland/deno/pull/18868) |
