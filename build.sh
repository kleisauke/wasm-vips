...
VERSION_GLIB=2.77.0         # https://gitlab.gnome.org/GNOME/glib
...
VERSION_HWY=1.0.5           # https://github.com/google/highway
...
VERSION_VIPS=8.14.3         # https://github.com/libvips/libvips
