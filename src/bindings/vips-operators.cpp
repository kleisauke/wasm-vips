...
Image Image::dcrawload(const std::string &filename, emscripten::val js_options)
{
    Image out;

    Image::call("dcrawload", nullptr,
                (new Option)
                    ->set("out", &out)
                    ->set("filename", filename),
                js_options);
...
Image Image::dcrawload_buffer(const std::string &buffer, emscripten::val js_options)
{
    Image out;
    ...
    Image::call("dcrawload_buffer", nullptr, options, js_options);

    return out;
}

Image Image::dcrawload_source(const Source &source, emscripten::val js_options)
{
    Image out;

    Image::call("dcrawload_source", nullptr,
                (new Option)
                    ->set("out", &out)
                    ->set("source", source),
                js_options);
...
Image Image::magickload_source(const Source &source, emscripten::val js_options)
{
    Image out;

    Image::call("magickload_source", nullptr,
                (new Option)
                    ->set("out", &out)
                    ->set("source", source),
                js_options);
